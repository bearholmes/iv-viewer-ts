...
async function compileCss () {
  ...
  const distUnminified = writeFile('./dist/iv-viewer-ts.css', unminifiedCss.toString());
  const distMinified = writeFile('./dist/iv-viewer-ts.min.css', minifiedCss.toString());
